let MapGeo = {
    ...
    ec01_map_geoMap() {
        const that = this;
        let chart_geo = echarts.init($("#ec01_map_geoMap")[0]);
        let chart_bmap = echarts.init($("#ec01_map_bMap")[0]);
        this.charts.ec01_map_geoMap = chart_geo;
        this.charts.ec01_map_bMap = chart_bmap;
        chart_geo.setOption(com_charts);
        chart_bmap.setOption(com_charts);
        let com_opt = {
            grid: {
                top: '5%'
            },
